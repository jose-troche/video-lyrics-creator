...
from .config import DEFAULT_AUTHOR, DEFAULT_VISUAL_STYLE, Project
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("-p", "--project", default=DEFAULT_PROJECT, help="project file (project.json)")
    ...
    subparsers.add_parser("resolve-check", help="check that Resolve is reachable for scripting")
